  ...
  return (
    <>
      <div className="folder-explorer h-[96.5vh] overflow-hidden animate__animated animate__fadeIn animate__faster">
        <div
          className="top border-b border-white border-opacity-10 flex items-center border-t"
          style={{
        ...
        >
          <div
            ...
            className="arrows flex items-center justify-around border-r border-white border-opacity-10 mr-4 pr-2 py-2 pl-2"
          >
            <svg
              width="24"
              onClick={() => {
              ...
              >
                ...
                <defs>
                  <clipPath id="clip0_8_68">
                    <rect width="21" height="21" fill="var(--icon-color)" />
                  </clipPath>
                </defs>
              </svg>
                ...
                {runtime.currentPath
                  ...
                  .map((path, key, arr) => (
                    <p
                      ...
                      className={`underline w-min whitespace-nowrap cursor-pointer font-medium ${
          ...
          <div className="page-options flex items-center min-w-[150px]">
            ...
            <div className="result-layout-options bg-sidebar flex items-center rounded-md mr-4">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                className={`${
                  runtime.listStyle === 'GRID' ? 'opacity-70' : 'opacity-50'
                } cursor-pointer hover:opacity-70 p-1 min-w-[35px] min-h-[25px] transition-all`}
                style={{
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                className={`${
                  runtime.listStyle === 'LIST' ? 'opacity-70' : 'opacity-50'
                } cursor-pointer hover:opacity-70 p-1 min-w-[35px] min-h-[25px] transition-all`}
                style={{
                  backgroundColor: 'var(--sidebar-bg)',
                }}
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                className={`${
                  runtime.listStyle === 'TREE' ? 'opacity-70' : 'opacity-50'
                } cursor-pointer hover:opacity-70 p-1 min-w-[35px] min-h-[25px] transition-all`}
                style={{
                  backgroundColor: 'var(--sidebar-bg)',
                }}
              >
                <g clipPath="url(#clip0_8_91)">
                  <path
                ...
                <defs>
                  <clipPath id="clip0_8_91">
                    <rect width="15" height="15" fill="var(--icon-color)" />
                  </clipPath>
                </defs>
              </svg>
            </div>
        ...
        <div className="explorer-contents">
          <div
            ...
            className="top-content border-b border-white border-opacity-10 pb-2 w-full mt-2 flex items-center justify-between pl-12 pr-12"
          >
            <p className="min-w-[250px] pl-2 flex items-center font-medium">
              <span
